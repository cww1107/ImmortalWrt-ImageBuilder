...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES bash quickfile luci-app-quickfile luci-i18n-quickfile-zh-cn -luci-app-filemanager -luci-i18n-filemanager-zh-cn"
...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES ddns-scripts-dnspod luci-i18n-ddns-zh-cn"
